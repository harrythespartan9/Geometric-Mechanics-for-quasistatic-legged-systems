...
function h = plotPathArrowV2(ax, aX, aY, arrSize, arrAngle, lW, c, arrType)

    % based on the arrow type, execute the following
    ...
    switch size(tipLoc, 1)
        ...
        case 1
            ...
            for i = 1:numel(plot_angle)
                ...
                plot_from(i, :) = plot_to ...
                    - arrSize*[ cos(plot_angle(i)), sin(plot_angle(i)) ];
            end
            % Plot the arrow
            h = plot(ax,...
        ...
        otherwise
            ...
            for i = 1:size(tipLoc, 1)
                ...
                for j = 1:numel(plot_angle)
                    plot_from(j, :) = plot_to ...
                        - arrSize*[cos(plot_angle(j)), sin(plot_angle(j))];
                end
                h{i} = plot(ax,...
                [plot_from(1, 1) plot_to(1) plot_from(2, 1)],...
                [plot_from(1, 2) plot_to(2) plot_from(2, 2)],...
