...
function [out, z] = stitchSE2trajectories(xi, yi, thetai, zxi, zyi, zthetai, xj, yj, thetaj, zxj, zyj, zthetaj, ibefore, iduring, jduring, jafter)
    ...
    phi_i = [xi; yi; thetai];
    phi_j = repmat( [zxi; zyi; zthetai], 1, size([xj; yj; thetaj], 2) ) + adginv(zthetai)*[xj; yj; thetaj];
    ...
    phi_j_after  = repmat( [zxi; zyi; zthetai] + adginv(zthetai)*[zxj; zyj; zthetaj], 1, sum(jafter)+1 ); phi_j_after = phi_j_after(:, 1:end-1);
    ...
    z = [zxi; zyi; zthetai] + adginv(zthetai)*[zxj; zyj; zthetaj]; % explicity compute the pullback
