% This is a "Path2_MobilityV2" class for defining paths on level-2 no-slip 
...
% ... It deviates from the "Path2_Mobility" class in the fact that it
% ... allows changing body morphing DoFs and analyzes the corresponding
% ... change in the "mobility" of the system.

classdef Path2_MobilityV2
    ...
    properties (SetAccess = public)
        ...
        ai        % the shape variable encoding the first limb in the 
                  % ... contact state
                  % ... ... This is a 2D-meshgrid variable
    ...
    methods
        ...
        % Constructor
        function thisPath2 = Path2_MobilityV2(sIdx, ...
            ...
            % ... below
            % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
            thisPath2 = Path2_MobilityV2.computePerpendicularCoordinates...
                                                            ( thisPath2 );
            ...
            thisPath2 = Path2_MobilityV2.computeParallelCoordinates...
                                                            ( thisPath2 );
            thisPath2 = Path2_MobilityV2.computeSpecificParallelCoordinates...
    ...
    methods (Static)
        ...
        function [ thatPath2 ] = constructComplementaryStance(thisPath2,...
            ...
            % construct the complimentary submanifold "Path2_MobilityV2" 
            % obj
            thatPath2 = Path2_MobilityV2(sThatIdx,...
                                       kin, kinfunc, p_kin, p_info,...
                                       intTime, refPt);
        end
