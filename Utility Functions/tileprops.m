...
temp_idx(C.start(1):C.grid(1)-1,...
    C.start(2):C.grid(2)-1) = reshape(find(ones(C.grid)),C.grid(2),C.grid(1))';
row_temp_idx(C.start(1):C.grid(1)-1,...
    C.start(2):C.grid(2)-1) = repmat((C.start(1):C.grid(1)-1)',1,C.grid(2));
col_temp_idx(C.start(1):C.grid(1)-1,... % col index values
    C.start(2):C.grid(2)-1) = repmat((C.start(2):C.grid(2)-1),C.grid(1),1);
