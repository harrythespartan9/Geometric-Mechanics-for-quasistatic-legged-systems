    ...
    methods (Static)
        ...
        function thisPath2 = computeSpecificParallelCoordinates...
            ...
            thisPath2.aParaRef.aVel = ...
                sum(abs(diff(thisPath2.aParaRef.y)./...
                    repmat(diff(thisPath2.aParaRef.t), 1, 2)), 2);
            thisPath2.aParaRef.aAccln = ...
                sum(abs(diff(thisPath2.aParaRef.aVel)./...
                    repmat(diff(thisPath2.aParaRef.t(1:end-1)), 1, 2)), 2);
