...
classdef Path2_Mobility
    ...
    methods (Static)
        ...
        % concatenate the parallel coordinates
        % ... to check reachable sets over gaits spanning different leaves
        % ... generated by the foliation of F, we want to make it easy by
        % ... concatenating the parallel coordinates split over different
        % ... branches
        function paraOut = concatenateParallelCoords(thisPath2, dNumLvlSet)
            if ~strcmp(thisPath2.slipMode, 'branched')
                error(['ERROR! This method is setup for the branched case. ' ...
                    'For more information, refer to usage provided in ' ...
        ...
        % extract valid level-sets indices in the contacted parallel
        % coordinates
        % ... such extracted indices help explore the reachable set of
        % ... displacements generated by gaits spanning different leaves
        % ... generated by the foliation of F
        % ... "dNumLvlSet" requests a certain number and if the number of
        % ... valid sets exceeds that, we 
        ...
        function [tOff, tMax, thisPath2] = ...
                computeToffFromPerpCoord(refPt, thisPath2, gaitInputMode)
            if nargin < 3
                gaitInputMode = 'std';
            end
            % unpack
